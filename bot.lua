...
auth_phone  = { ["818043728087"] = true }

-- 만약 여러개의 폰 번호를 등록하고 싶다면 다음과 같이 작성한다.
--[[
...
function SendHelp(user_id)
    -- /tmp/tg/bot/help.txt 파일이 있어야 한다
...
function on_msg_receive (msg)
    ...
    -- 사용자 정보를 print 한다.
    print("Name     : ", msg.from.print_name)       -- 메시지 보낸사람 이름
    print("Phone    : ", msg.from.phone)            -- 메시지 보낸사람 전화번호
